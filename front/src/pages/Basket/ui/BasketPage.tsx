      ...
      <div className="Shop__content pt-[60px] px-[90px]">
        <div className="Catalog w-[386px] text-[20px] font-medium rounded-[15px] border-[1px] border-solid border-lightGray mb-[116px]">
          {data.map(({ text }, index) => (
            <div
              key={index}
              className="title pl-[18px] pt-[15px] pb-[15px] border-b border-solid border-lightGray flex gap-[235px]"
            >
              ...
              <button>
                {text === "Каталог" ? (
                  ...
                  >
                    <path
                      d="M-4.76837e-07 1.27611L1.1775 0L9.4175 8.93006C9.57389 9.09949 9.78596 9.19467 10.0071 
          ...
          <div className="title pl-[18px] pt-[15px] pb-[15px]">
            <Button
              className="py-[15px] bg-black text-white text-lg font-semibold px-[130px] border-[1px] border-black rounded-[5px]"
              label="Показать"
            />
          </div>
        </div>
